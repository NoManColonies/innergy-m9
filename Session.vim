...
badd +17 innergy-m9-api/start/routes.js
...
57
normal! zo
let s:l = 54 - ((53 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
54
